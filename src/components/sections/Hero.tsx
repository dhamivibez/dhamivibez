  ...
  return (
    <section className='flex h-screen w-full justify-center'>
      <div className='flex flex-col items-center justify-center space-y-8 px-4 py-6'>
        <motion.h1
          className='bg-linear-to-r from-purple-500 via-fuchsia-500 to-pink-500 bg-clip-text text-center text-5xl font-extrabold text-transparent md:text-7xl'
        ...
        <SocialIcons className='pt-4' delay={1.0} />
      </div>
    </section>
  );
};
